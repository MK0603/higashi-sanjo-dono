...
fillBox(15, 20, 50, 25, 6, 45, '#0d131a'); // 屋根
// 柱を等間隔で立てる
for (let pz=54; pz<=92; pz+=8) {
    fillBox(18, 24, pz, 2, 20, 2, '#1a120c');
    fillBox(36, 24, pz, 2, 20, 2, '#1a120c');
}
fillBox(15, 38, 50, 25, 2, 45, '#241a12'); // 床

// 左の釣殿（池にせり出す部分 z=40〜50）
fillBox(10, 18, 40, 35, 8, 12, '#0d131a'); 
fillBox(14, 24, 42, 2, 20, 2, '#1a120c');
fillBox(38, 24, 42, 2, 20, 2, '#1a120c');
fillBox(14, 24, 48, 2, 20, 2, '#1a120c');
fillBox(38, 24, 48, 2, 20, 2, '#1a120c');
fillBox(10, 38, 40, 35, 2, 12, '#241a12'); 
fillBox(24, 34, 41, 3, 4, 3, '#fc8a18ff'); // 灯籠


// 6. 右側の渡殿と釣殿 (x=120〜145, z=50〜95)
fillBox(120, 20, 50, 25, 6, 45, '#0d131a'); // 屋根
for (let pz=54; pz<=92; pz+=8) {
    fillBox(122, 24, pz, 2, 20, 2, '#1a120c');
    fillBox(140, 24, pz, 2, 20, 2, '#1a120c');
}
fillBox(120, 38, 50, 25, 2, 45, '#241a12'); // 床

// 右の釣殿 (z=40〜50)
fillBox(115, 18, 40, 35, 8, 12, '#0d131a');
fillBox(118, 24, 42, 2, 20, 2, '#1a120c');
fillBox(142, 24, 42, 2, 20, 2, '#1a120c');
fillBox(118, 24, 48, 2, 20, 2, '#1a120c');
fillBox(142, 24, 48, 2, 20, 2, '#1a120c');
fillBox(115, 38, 40, 35, 2, 12, '#241a12'); 
fillBox(130, 34, 41, 3, 4, 3, '#f07f00'); 


// 7. 寝殿（一番手前 z=95〜99、ここから庭を見下ろす）
fillBox(4, 4, 96, 6, 44, 4, '#0f0a07');   // 左の柱
fillBox(150, 4, 96, 6, 44, 4, '#0f0a07'); // 右の柱
fillBox(0, 0, 96, width, 4, 4, '#0a0705'); // 上部の梁
fillBox(0, 38, 96, width, 4, 4, '#17110c'); // 床
fillBox(10, 35, 96, 140, 2, 2, '#0f0a07');  // 高欄
// 御簾
for(let z=96; z<=97; z++){
